...
const datos = require('./datos_update')
const credentials = {
...
function consulta(desdeString,hastaString){
    return new Promise(( resolve, reject) => {
        ...
        var message_to_sign = time + '/api/v1/traffic/violations/updated'
        ...
        request({
            url: 'https://api.sitve.com/api/v1/traffic/violations/updated?dateFrom='+desdeString+'&dateTo='+hastaString,
            headers: headers
