...
const datos = require('./datos_cobro')
const credentials = {
...
function consulta(desdeString,hastaString){
    return new Promise(( resolve, reject) => {
        ...
        var message_to_sign = time + '/api/v1/traffic/collections/operations'
        ...
        request({
            url: 'https://api.sitve.com/api/v1/traffic/collections/operations?dateFrom='+desdeString+'&dateTo='+hastaString,
            headers: headers
